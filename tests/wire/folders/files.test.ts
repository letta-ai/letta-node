...
describe("Files", () => {
    test("list", async () => {
        ...
        const response = await client.folders.files.list("folder_id");
    ...
    test("delete", async () => {
        ...
        server.mockEndpoint().delete("/v1/folders/folder_id/file_id").respondWith().statusCode(200).build();

        const response = await client.folders.files.delete("folder_id", "file_id");
