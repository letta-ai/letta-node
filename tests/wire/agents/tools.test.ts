...
describe("Tools", () => {
    test("list", async () => {
        ...
        const response = await client.agents.tools.list("agent_id");
    ...
    test("attach", async () => {
        ...
        const response = await client.agents.tools.attach("agent_id", "tool_id");
        expect(response).toEqual({
            created_by_id: "created_by_id",
            last_updated_by_id: "last_updated_by_id",
            created_at: "2024-01-15T09:30:00Z",
    ...
    test("detach", async () => {
        ...
        const response = await client.agents.tools.detach("agent_id", "tool_id");
        expect(response).toEqual({
            created_by_id: "created_by_id",
            last_updated_by_id: "last_updated_by_id",
            created_at: "2024-01-15T09:30:00Z",
