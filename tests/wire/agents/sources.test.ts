...
describe("Sources", () => {
    test("attach", async () => {
        ...
        const response = await client.agents.sources.attach("agent_id", "source_id");
    ...
    test("detach", async () => {
        ...
        const response = await client.agents.sources.detach("agent_id", "source_id");
        expect(response).toEqual({
            created_by_id: "created_by_id",
            last_updated_by_id: "last_updated_by_id",
            created_at: "2024-01-15T09:30:00Z",
    ...
    test("list", async () => {
        ...
        const response = await client.agents.sources.list("agent_id");
        expect(response).toEqual([
            {
                name: "name",
                description: "description",
