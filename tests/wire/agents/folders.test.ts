...
describe("Folders", () => {
    test("attach", async () => {
        ...
        const response = await client.agents.folders.attach("agent_id", "folder_id");
    ...
    test("detach", async () => {
        ...
        const response = await client.agents.folders.detach("agent_id", "folder_id");
        expect(response).toEqual({
            created_by_id: "created_by_id",
            last_updated_by_id: "last_updated_by_id",
            created_at: "2024-01-15T09:30:00Z",
    ...
    test("list", async () => {
        ...
        const response = await client.agents.folders.list("agent_id");
        expect(response).toEqual([
            {
                name: "name",
                description: "description",
