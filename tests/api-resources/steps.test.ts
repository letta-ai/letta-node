...
describe('resource steps', () => {
  ...
  test.skip('retrieve', async () => {
    const responsePromise = client.steps.retrieve('step_id');
  ...
  test.skip('listMessages', async () => {
    const responsePromise = client.steps.listMessages('step_id');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('retrieveMetrics', async () => {
    const responsePromise = client.steps.retrieveMetrics('step_id');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('retrieveTrace', async () => {
    const responsePromise = client.steps.retrieveTrace('step_id');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  // Prism tests are disabled
  test.skip('updateFeedback', async () => {
    const responsePromise = client.steps.updateFeedback('step_id', {});
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
