...
export const InternalTemplateAgentCreate: core.serialization.ObjectSchema<
    serializers.InternalTemplateAgentCreate.Raw,
    Letta.InternalTemplateAgentCreate
> = core.serialization.object({
    ...
    toolRules: core.serialization.property(
        "tool_rules",
        core.serialization.list(InternalTemplateAgentCreateToolRulesItem).optional(),
    ),
    ...
    responseFormat: core.serialization.property(
        "response_format",
        InternalTemplateAgentCreateResponseFormat.optional(),
    ),
