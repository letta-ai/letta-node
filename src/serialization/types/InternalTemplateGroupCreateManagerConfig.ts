...
export const InternalTemplateGroupCreateManagerConfig: core.serialization.Schema<
    serializers.InternalTemplateGroupCreateManagerConfig.Raw,
    Letta.InternalTemplateGroupCreateManagerConfig
