...
export const InternalTemplateAgentCreateToolRulesItem: core.serialization.Schema<
    serializers.InternalTemplateAgentCreateToolRulesItem.Raw,
    Letta.InternalTemplateAgentCreateToolRulesItem
