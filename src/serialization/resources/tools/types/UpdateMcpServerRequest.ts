...
import { UpdateStdioMcpServer } from "../../../types/UpdateStdioMcpServer";
...
> = core.serialization.undiscriminatedUnion([UpdateStdioMcpServer, UpdateSsemcpServer, UpdateStreamableHttpmcpServer]);

export declare namespace UpdateMcpServerRequest {
    export type Raw = UpdateStdioMcpServer.Raw | UpdateSsemcpServer.Raw | UpdateStreamableHttpmcpServer.Raw;
}
