...
export const TemplatesSaveTemplateVersionResponse: core.serialization.ObjectSchema<
    serializers.TemplatesSaveTemplateVersionResponse.Raw,
    Letta.TemplatesSaveTemplateVersionResponse
