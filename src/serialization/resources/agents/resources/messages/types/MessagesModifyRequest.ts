...
export const MessagesModifyRequest: core.serialization.Schema<
    serializers.agents.MessagesModifyRequest.Raw,
    Letta.agents.MessagesModifyRequest
...
export declare namespace MessagesModifyRequest {
    export type Raw =
