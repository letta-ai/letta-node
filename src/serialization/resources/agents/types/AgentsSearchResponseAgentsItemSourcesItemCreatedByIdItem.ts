...
export const AgentsSearchResponseAgentsItemSourcesItemCreatedByIdItem: core.serialization.Schema<
    serializers.AgentsSearchResponseAgentsItemSourcesItemCreatedByIdItem.Raw,
