...
export const AgentsSearchResponseAgentsItemSourcesItemEmbeddingConfigAzureDeploymentItem: core.serialization.Schema<
    serializers.AgentsSearchResponseAgentsItemSourcesItemEmbeddingConfigAzureDeploymentItem.Raw,
