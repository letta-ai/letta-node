...
export const AgentsSearchResponseAgentsItemToolExecEnvironmentVariablesItemCreatedAtItem: core.serialization.Schema<
    serializers.AgentsSearchResponseAgentsItemToolExecEnvironmentVariablesItemCreatedAtItem.Raw,
