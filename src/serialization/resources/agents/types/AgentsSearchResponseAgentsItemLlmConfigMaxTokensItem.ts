...
export const AgentsSearchResponseAgentsItemLlmConfigMaxTokensItem: core.serialization.Schema<
    serializers.AgentsSearchResponseAgentsItemLlmConfigMaxTokensItem.Raw,
    Letta.AgentsSearchResponseAgentsItemLlmConfigMaxTokensItem
