...
export const AgentsSearchResponseAgentsItemToolsItemDescriptionItem: core.serialization.Schema<
    serializers.AgentsSearchResponseAgentsItemToolsItemDescriptionItem.Raw,
