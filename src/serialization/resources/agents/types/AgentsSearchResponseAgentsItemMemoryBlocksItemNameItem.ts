...
export const AgentsSearchResponseAgentsItemMemoryBlocksItemNameItem: core.serialization.Schema<
    serializers.AgentsSearchResponseAgentsItemMemoryBlocksItemNameItem.Raw,
