...
export const AgentsSearchResponseAgentsItemEmbeddingConfigHandleItem: core.serialization.Schema<
    serializers.AgentsSearchResponseAgentsItemEmbeddingConfigHandleItem.Raw,
