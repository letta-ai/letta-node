...
export const AgentsSearchResponseAgentsItemToolsItemCreatedByIdItem: core.serialization.Schema<
    serializers.AgentsSearchResponseAgentsItemToolsItemCreatedByIdItem.Raw,
