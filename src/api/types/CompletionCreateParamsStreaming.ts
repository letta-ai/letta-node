...
export interface CompletionCreateParamsStreaming {
    messages: CompletionCreateParamsStreaming.Messages.Item[];
    model: CompletionCreateParamsStreaming.Model;
    audio?: Letta.ChatCompletionAudioParam;
    frequency_penalty?: number;
    function_call?: CompletionCreateParamsStreaming.FunctionCall;
    ...
    modalities?: CompletionCreateParamsStreaming.Modalities.Item[];
    n?: number;
    parallel_tool_calls?: boolean;
    prediction?: Letta.ChatCompletionPredictionContentParam;
    presence_penalty?: number;
    reasoning_effort?: CompletionCreateParamsStreaming.ReasoningEffort;
    response_format?: CompletionCreateParamsStreaming.ResponseFormat;
    seed?: number;
    service_tier?: CompletionCreateParamsStreaming.ServiceTier;
    stop?: CompletionCreateParamsStreaming.Stop;
    store?: boolean;
    stream_options?: Letta.ChatCompletionStreamOptionsParam;
    temperature?: number;
    tool_choice?: CompletionCreateParamsStreaming.ToolChoice;
...
export namespace CompletionCreateParamsStreaming {
