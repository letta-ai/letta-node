...
export class Providers {
     ...
     */
    public retrieve(providerId: string, requestOptions?: Providers.RequestOptions): core.HttpResponsePromise<void> {
        return core.HttpResponsePromise.fromPromise(this.__retrieve(providerId, requestOptions));
    }
