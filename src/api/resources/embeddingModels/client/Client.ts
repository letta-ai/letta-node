...
export class EmbeddingModels {
     ...
     */
    public list(requestOptions?: EmbeddingModels.RequestOptions): core.HttpResponsePromise<Letta.EmbeddingConfig[]> {
    ...
    private async __list(
        ...
        if (_response.ok) {
            return { data: _response.body as Letta.EmbeddingConfig[], rawResponse: _response.rawResponse };
        }
