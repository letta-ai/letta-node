...
export class EmbeddingModels {
     ...
     */
    public async list(requestOptions?: EmbeddingModels.RequestOptions): Promise<Letta.EmbeddingConfig[]> {
        ...
        if (_response.ok) {
            return serializers.embeddingModels.list.Response.parseOrThrow(_response.body, {
