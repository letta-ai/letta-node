...
export interface AgentsSearchResponseAgentsItemToolRulesItemItemChildOutputMapping {
    toolName: string;
    type?: Letta.AgentsSearchResponseAgentsItemToolRulesItemItemChildOutputMappingType;
