...
export class MemoryVariables {
    constructor(protected readonly _options: MemoryVariables.Options = {}) {}
    ...
    ): core.HttpResponsePromise<Letta.agents.MemoryVariablesListResponse> {
    ...
    private async __list(
        agentId: string,
        requestOptions?: MemoryVariables.RequestOptions,
    ): Promise<core.WithRawResponse<Letta.agents.MemoryVariablesListResponse>> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.LettaEnvironment.LettaCloud,
                `v1/agents/${encodeURIComponent(agentId)}/core-memory/variables`,
            ),
            method: "GET",
            headers: {
                "X-Project":
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.LettaTimeoutError(
                    "Timeout exceeded when calling GET /v1/agents/{agent_id}/core-memory/variables.",
                );
            case "unknown":
                throw new errors.LettaError({
