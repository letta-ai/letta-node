...
export class Context {
    ...
    ): core.HttpResponsePromise<Letta.ContextWindowOverview> {
    ...
    private async __retrieve(
        agentId: string,
        requestOptions?: Context.RequestOptions,
    ): Promise<core.WithRawResponse<Letta.ContextWindowOverview>> {
        ...
        if (_response.ok) {
            return { data: _response.body as Letta.ContextWindowOverview, rawResponse: _response.rawResponse };
        }
