...
export class Agents {
     ...
     */
    public async count(requestOptions?: Agents.RequestOptions): Promise<number> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
     ...
     */
    public async exportFile(agentId: string, requestOptions?: Agents.RequestOptions): Promise<string> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
     ...
     */
    public async closeAllOpenFiles(agentId: string, requestOptions?: Agents.RequestOptions): Promise<string[]> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
     ...
     */
    public async openFile(agentId: string, fileId: string, requestOptions?: Agents.RequestOptions): Promise<string[]> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
     ...
     */
    public async closeFile(agentId: string, fileId: string, requestOptions?: Agents.RequestOptions): Promise<unknown> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
     ...
     *     })
     */
    public async summarizeAgentConversation(
        agentId: string,
