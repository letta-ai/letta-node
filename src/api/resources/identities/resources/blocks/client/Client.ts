...
export class Blocks {
     ...
     */
    public list(identityId: string, requestOptions?: Blocks.RequestOptions): core.HttpResponsePromise<void> {
    ...
    private async __list(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                ...
                `v1/identities/${encodeURIComponent(identityId)}/blocks`,
            ),
            method: "GET",
            headers: {
                "X-Project":
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.LettaTimeoutError(
                    "Timeout exceeded when calling GET /v1/identities/{identity_id}/blocks.",
                );
            case "unknown":
                throw new errors.LettaError({
