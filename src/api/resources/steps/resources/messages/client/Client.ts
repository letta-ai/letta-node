...
export class Messages {
    ...
    ): core.HttpResponsePromise<Letta.steps.MessagesListResponseItem[]> {
    ...
    private async __list(
        ...
        request: Letta.steps.MessagesListRequest = {},
        requestOptions?: Messages.RequestOptions,
    ): Promise<core.WithRawResponse<Letta.steps.MessagesListResponseItem[]>> {
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                ...
                `v1/steps/${encodeURIComponent(stepId)}/messages`,
            ),
            method: "GET",
            headers: {
                "X-Project":
