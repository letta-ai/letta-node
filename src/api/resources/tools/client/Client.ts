...
export class Tools {
    ...
    private async __count(
        ...
        const { include_base_tools: includeBaseTools } = request;
    ...
    private async __runToolFromSource(
        ...
        if (_response.ok) {
            return { data: _response.body as Letta.ToolReturnMessage, rawResponse: _response.rawResponse };
        }
    ...
    private async __listComposioApps(
        ...
        if (_response.ok) {
            return { data: _response.body as Letta.AppModel[], rawResponse: _response.rawResponse };
        }
    ...
    private async __listComposioActionsByApp(
        ...
        if (_response.ok) {
            return { data: _response.body as Letta.ActionModel[], rawResponse: _response.rawResponse };
        }
    ...
    private async __listMcpServers(
        ...
        if (_response.ok) {
            return {
                data: _response.body as Record<string, Letta.ListMcpServersResponseValue>,
                rawResponse: _response.rawResponse,
            };
        }
    ...
    private async __addMcpServer(
        ...
        if (_response.ok) {
            return { data: _response.body as Letta.AddMcpServerResponseItem[], rawResponse: _response.rawResponse };
        }
    ...
    private async __listMcpToolsByServer(
        ...
        if (_response.ok) {
            return { data: _response.body as Letta.McpTool[], rawResponse: _response.rawResponse };
        }
    ...
    private async __deleteMcpServer(
        ...
        if (_response.ok) {
            return { data: _response.body as Letta.DeleteMcpServerResponseItem[], rawResponse: _response.rawResponse };
        }
    ...
    private async __updateMcpServer(
        ...
        if (_response.ok) {
            return { data: _response.body as Letta.UpdateMcpServerResponse, rawResponse: _response.rawResponse };
        }
