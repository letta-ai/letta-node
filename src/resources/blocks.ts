...
export class Blocks extends APIResource {
   ...
   * Create Block
   */
  create(body: BlockCreateParams, options?: RequestOptions): APIPromise<CoreMemoryBlocksAPI.Block> {
   ...
   * Retrieve Block
   */
  retrieve(blockID: string, options?: RequestOptions): APIPromise<CoreMemoryBlocksAPI.Block> {
  ...
  listAgents(
    blockID: string,
    query: BlockListAgentsParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<BlockListAgentsResponse> {
...
export type BlockListResponse = Array<CoreMemoryBlocksAPI.Block>;

export type BlockDeleteResponse = unknown;

export type BlockCountResponse = number;

export type BlockListAgentsResponse = Array<AgentsAPI.AgentState>;
...
export interface BlockListAgentsParams {
  /**
