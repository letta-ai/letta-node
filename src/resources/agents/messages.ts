...
export namespace LettaStreamingResponse {
   ...
   * number of steps taken by the agent. cached_input_tokens (int): The number of
   * input tokens served from cache. cache_write_tokens (int): The number of input
   * tokens written to cache (Anthropic only). reasoning_tokens (int): The number of
   * reasoning/thinking tokens generated.
   */
