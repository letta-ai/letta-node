...
export interface MessageCreateResponse {
   ...
   */
  messages: Array<MessageCreateResponse.UnionMember0> | Array<MessageCreateResponse.UnionMember1>;
...
export namespace MessageCreateResponse {
  ...
  /**
   * Base class for simplified Letta message response type. This is intended to be
   * used for developers who want the internal monologue, function calls, and
   * function returns in a simplified format that does not include additional
   * information other than the content and timestamp.
   *
   * Attributes: id (str): The ID of the message date (datetime): The date the
   * message was created in ISO format
   */
