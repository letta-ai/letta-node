...
[![NPM version](<https://img.shields.io/npm/v/letta-sdk.svg?label=npm%20(stable)>)](https://npmjs.org/package/letta-sdk) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/letta-sdk)
...
> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install letta-sdk`
...
```ts
import LettaSDK from 'npm:letta-sdk';
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/letta-sdk-typescript/issues) with questions, bugs, or suggestions.
